...
public class LinkedinEducation {
  ...
  public LinkedinEducation(String companyId, String companyUrn, String companyLink1, String logo, String title,
      String subtitle, String caption, Boolean breakdown, List<LinkedinSubComponent> subComponents) {
    super();
